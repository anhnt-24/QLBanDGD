        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="col-span-2 flex flex-col gap-2">
            ...
            <div className="mt-10 border-t-1 border-b-1 border-gray-300 p-2">
              <h4 className="mt-2">Điện máy PTIT cam kết</h4>
            ...
            <div className="border-b-1 border-gray-300 p-2">
              ...
              <div className="mt-2 flex flex-col gap-2 text-sm text-gray-700">
                <p>
                  Sản phẩm được thiết kế tinh tế, phù hợp cho các dịp đặc biệt
                  như tiệc, lễ hội, hoặc chụp ảnh kỷ niệm.
                </p>
                <p>
                  Chất liệu vải cao cấp, thoáng mát và dễ chịu khi mặc trong
                  thời gian dài.
                </p>
                <p>
                  Phù hợp với nhiều dáng người, dễ phối đồ và tạo phong cách
                  riêng.
                </p>
              </div>
            </div>
            {product && <CommentSection product={product} />}
          </div>
          <div className="flex flex-3 flex-col">
            ...
            <div className="border-primary-200 mt-2 rounded-xl border-1 p-2">
